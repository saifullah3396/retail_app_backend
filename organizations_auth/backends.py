...
class OrganizationUserBackend(BaseBackend):
    """
    ...
    def _get_group_permissions(self, user_obj):
        user_groups_field = ORGANIZATION_USER_MODEL._meta.get_field('groups')
        user_groups_query = \
            'organization_group__%s' % user_groups_field.related_query_name()
