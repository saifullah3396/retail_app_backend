        ...
        self.test = [
            {
                ...
                'request': [
                    {   # get deepstream_server by id, okay for staff
                        ...
                        'response_check': lambda test, data: (
                            test.assertDictContainsSubset(
                                {
                                    'id': str(self.deepstream_servers['ds0_o1'].id),
                                    ...
                                    'connected_at': django_datetime_to_drf_format(
                                        self.deepstream_servers['ds0_o1'].connected_at),
                                    'last_echo_at': django_datetime_to_drf_format(
                                        self.deepstream_servers['ds0_o1'].last_echo_at),
                    ...
                    {   # get deepstream_server by id, okay for org admin itself
                        'test_name': 'get_ds0_o1_by_org_1_admin',
                        'args': {'pk': self.deepstream_servers['ds0_o1'].id},
            ...
            },
            {
                ...
                'request': [
                    {   # get sub-org deepstream_server by id, okay for staff
                        'test_name': 'get_ds0_sub1_o1_by_staff',
                        ...
                        'response_check': lambda test, data: (
                            test.assertDictContainsSubset(
                                {
                                    'id': str(self.deepstream_servers['ds0_sub1_o1'].id),
                                    'ip_addr': 'rtsp://192.168.1.1',
                                    'mac_addr': self.deepstream_servers['ds0_sub1_o1'].mac_addr,
                                    # just a fix for annoying time format difference
                                    'connected_at': django_datetime_to_drf_format(
                                        self.deepstream_servers['ds0_sub1_o1'].connected_at),
                                    'last_echo_at': django_datetime_to_drf_format(
                                        self.deepstream_servers['ds0_sub1_o1'].last_echo_at),
                                    'status': DeepstreamServer.OFFLINE,
                    ...
                    {   # get sub-org deepstream_server by id, okay for org admin itself
                        ...
                        'test_name':
                            'get_ds0_sub1_o1_by_org_1_admin',
                        'args': {'pk': self.deepstream_servers['ds0_sub1_o1'].id},
                        'user': 'org_1_admin_user',
                        'status': status.HTTP_200_OK,
                        'response_check': lambda test, data: (
                    ...
                    {   # get sub-org deepstream_server by id, okay for sub-org admin
                        # itself
                        'test_name':
                            'get_ds0_sub1_o1_by_sub_1_org_1_admin',
                        'args': {'pk': self.deepstream_servers['ds0_sub1_o1'].id},
                        'user': 'sub_org_11_admin_user',
                        'status': status.HTTP_200_OK,
                        'response_check': lambda test, data: (
                    ...
                    {   # get sub-org deepstream_server by id, bad for other
                        ...
                        'test_name':
                            'get_ds0_sub1_o1_by_org_2_admin',
                        'args': {'pk': self.deepstream_servers['ds0_sub1_o1'].id},
                        'user': 'org_2_admin_user',
                        'status': status.HTTP_404_NOT_FOUND
                    },
                    {   # get sub-org deepstream_server by id, bad for other
                        ...
                        'test_name':
                            'get_ds0_sub1_o1_by_sub_1_org_2_admin',
                        'args': {'pk': self.deepstream_servers['ds0_sub1_o1'].id},
                    ...
                    {   # get sub-org deepstream_server by id, okay for staff who is in
                        # this org
                        'test_name': 'get_ds0_sub1_o1_by_employee',
                        'args': {'pk': self.deepstream_servers['ds0_sub1_o1'].id},
                        'user': 'employee_user',
                        'status': status.HTTP_200_OK,
                        'response_check': lambda test, data: (
                    ...
                    {   # get sub-org by id, forbidden for random user
                        'test_name': 'get_ds0_o2_by_other_user',
                        'args': {'pk': self.deepstream_servers['ds0_o2'].id},
                        'user': 'other_user',
                        'status': status.HTTP_403_FORBIDDEN
                    }
                ]
